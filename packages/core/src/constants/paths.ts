...
export const BACKEND_ROOT_PATH = resolve(PROJECT_ROOT_PATH, 'apps/backend');
export const ADMIN_ROOT_PATH = resolve(PROJECT_ROOT_PATH, 'apps/admin');
export const FRONTEND_ROOT_PATH = resolve(PROJECT_ROOT_PATH, 'apps/frontend');
